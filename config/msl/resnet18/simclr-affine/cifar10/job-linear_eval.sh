...
python -m he.train --config_path /home-mscluster/dtorpey/code/homography-estimation-v0/config/msl/resnet18/simclr-affine/cifar10/config.yaml --model_path /home-mscluster/dtorpey/code/homography-estimation-v0/results/resnet18/simclr-affine/stl10/80_model_stl10.pth
