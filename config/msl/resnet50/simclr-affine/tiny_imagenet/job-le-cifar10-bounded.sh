#!/bin/bash
#SBATCH --job-name=cifar10-resnet50-simclr-affine-bounded-linear_eval
...
--config_path /home-mscluster/dtorpey/code/homography-estimation-v0/config/msl/resnet50/simclr-affine/tiny_imagenet/config-le-cifar10-bounded.yaml \
