#!/bin/bash
#SBATCH --job-name=caltech101-resnet50-byol-affine-bounded-linear_eval
...
--config_path /home-mscluster/dtorpey/code/homography-estimation-v0/config/msl/resnet50/byol-affine/tiny_imagenet/config-bounded-le-caltech101.yaml \
--model_path /home-mscluster/dtorpey/code/homography-estimation-v0/results/resnet50/byol-affine-bounded/tiny_imagenet/90_model_tiny_imagenet.pth
