#!/bin/bash
#SBATCH --job-name=cifar100-resnet50-barlow_twins-affine-investigate-losses-bounded-linear_eval
...
--config_path /home-mscluster/dtorpey/code/homography-estimation-v0/config/msl/resnet50/barlow_twins-affine-investigate-losses/tiny_imagenet/config-bounded-le-cifar100.yaml \
