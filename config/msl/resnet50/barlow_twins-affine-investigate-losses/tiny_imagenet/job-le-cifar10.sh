...
--config_path /home-mscluster/dtorpey/code/homography-estimation-v0/config/msl/resnet50/barlow_twins-affine-investigate-losses/tiny_imagenet/config-le-cifar10.yaml \
